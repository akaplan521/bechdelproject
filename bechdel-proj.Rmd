...
bechdel$Decade <- as.factor(bechdel$Decade)
bechdel$Btest5 <- as.factor(bechdel$Btest5)

bech_by_decade <- ggplot(bechdel,
  ...
  scale_y_continuous(expand = c(0, 0, 0.05, 0), 
    ...
    scale_fill_manual(values=c('violet', 'purple', '#8c99ff', '#8cdeff', '#3e2359')) +
