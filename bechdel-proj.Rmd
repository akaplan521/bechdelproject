...
bechdHist <-
  ...
  labs(x = "Bechdel Score", 
       y = "Number of Films", 
       fill = NULL, 
       title = "Number of films by their bechdel rating")  +
